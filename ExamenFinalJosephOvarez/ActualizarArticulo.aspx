<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ActualizarArticulo.aspx.cs" Inherits="ExamenFinalJosephOvarez.ActualizarArticulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="GActualizarArticulo" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
    ...
    <div>
        ...
        <asp:DropDownList ID="DActualizarArticulo" runat="server" DataSourceID="SqlDataSource1" DataTextField="DescripcionArticulo" DataValueField="CodigoArticulo"></asp:DropDownList>
    ...
    <div>
        <h3>Actualice los siguentes datos</h3>
    ...
    <div>
        ...
        <asp:DropDownList ID="DTipoArticulo" runat="server" DataSourceID="SqlDataSource2" DataTextField="DescripcionTipo" DataValueField="CodigoTipo"></asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ExamenFinalConnectionString %>" SelectCommand="SELECT [CodigoTipo], [DescripcionTipo] FROM [TipoArticulo]"></asp:SqlDataSource>
    </div>
    <div>
