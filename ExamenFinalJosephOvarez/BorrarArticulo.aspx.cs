...
{
    public partial class BorrarArticulo : System.Web.UI.Page
    {
        ...
        protected void BBorrar_Click(object sender, EventArgs e)
        {
            ...
            {
                ClaseArticulos.SetCodigoArticulo(int.Parse(DBorrarArticulo.SelectedValue));
                if (ClaseArticulos.BorrarArticulo())
                {
                    ConsultarTabla();
                    DBorrarArticulo.DataBind();
        ...
        protected void ConsultarTabla()
        {
            ...
            da.Fill(dt);
            GBorrarArticulo.DataSource = dt;
            GBorrarArticulo.DataBind();
        }
        private Boolean VerificarEspacios()
        {
            Boolean Verificador = false;
            if (String.IsNullOrEmpty(DBorrarArticulo.Text))
